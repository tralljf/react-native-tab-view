...
class Pager extends React.Component {
  constructor() {
    ...
    _defineProperty(this, "handleEnteredIndexChange", _ref => {
      let [value] = _ref;
    ...
    _defineProperty(this, "transitionTo", index => {
      ...
      [cond(not(clockRunning(this.clock)), _reactNative.I18nManager.isRTL ? set(this.initialVelocityForSpring, multiply(-1, this.velocityX, this.springVelocityScale)) : set(this.initialVelocityForSpring, multiply(this.velocityX, this.springVelocityScale))), spring(this.clock, { ...state,
    ...
    _defineProperty(this, "translateX", block([onChange(this.gesturesEnabled, cond(not(this.gesturesEnabled), call([this.gesturesEnabled], this.toggleEnabled))), onChange(this.index, call([this.index], _ref2 => {
      let [value] = _ref2;
    ...
    [cond(not(this.isSwiping), set(this.gesturesEnabled, 1)), call([this.isSwiping, this.indexAtSwipeEnd, this.index], _ref3 => {
      let [isSwiping, indexAtSwipeEnd, currentIndex] = _ref3;
      const {
        keyboardDismissMode,
        onSwipeStart,
        onSwipeEnd
      ...
      if (isSwiping === TRUE) {
        ...
        if (keyboardDismissMode === 'auto') {
          const input = _reactNative.TextInput.State.currentlyFocusedField(); // When a gesture begins, blur the currently focused input
